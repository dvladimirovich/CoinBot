        ...
        protected override async Task<string> PrepareAsync(IActivity activity, CancellationToken token)
        {
            ...
            if (message != null && !string.IsNullOrWhiteSpace(message.Text))
            {
                if (message.Text.Equals("exit", StringComparison.InvariantCultureIgnoreCase) ||
                    message.Text.Equals("quit", StringComparison.InvariantCultureIgnoreCase) ||
                    message.Text.Equals("cancel", StringComparison.InvariantCultureIgnoreCase) ||
                    message.Text.Equals("start over", StringComparison.InvariantCultureIgnoreCase))
                {
                    return message.Text;
                }
            }
